 ...
 * {@link OnCallsTabYourCallsFragmentListener} interface
 * to handle interaction events.
 * Use the {@link CallsTabYourCallsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
@Deprecated
public class CallsTabYourCallsFragment extends Fragment implements AbsListView.OnScrollListener {
    private static final String TAG = CallsTabYourCallsFragment.class.getSimpleName();
    ...
    private static final String ARG_PICUP_NUMBER = "android.idt.net.com.picup.calling.CallsTabYourCallsFragment.PICUP_NUMBER";
    ...
    private OnCallsTabYourCallsFragmentListener listener;
    ...
    public CallsTabYourCallsFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static CallsTabYourCallsFragment newInstance(String picupNumber) {
        CallsTabYourCallsFragment fragment = new CallsTabYourCallsFragment();
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnCallsTabYourCallsFragmentListener) {
            listener = (OnCallsTabYourCallsFragmentListener) context;
        } else {
            throw new RuntimeException(context.toString() + " must implement OnCallsTabYourCallsFragmentListener");
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View callsTabYourCallsView = inflater.inflate(R.layout.calls_tab_your_calls, container, false);
        callListView = (ListView)callsTabYourCallsView.findViewById(R.id.your_calls_listview);
        swipeRefreshLayout = (SwipeRefreshLayout)callsTabYourCallsView.findViewById(R.id.swiperefresh);
        ...
        swipeRefreshLayout.setOnRefreshListener(
                new SwipeRefreshLayout.OnRefreshListener() {
                    ...
                    public void onRefresh() {
                        Logger.log("CallsTabYourCallsFragment - onRefresh called from SwipeRefreshLayout");
    ...
    public void setUserVisibleHint(boolean visible) {
        ...
        Logger.log("CallsTabYourCallsFragment - setUserVisibleHint - visible:"+visible);
    }

    @Override
    public void onResume() {
        super.onResume();
        Logger.log("CallsTabYourCallsFragment - onResume - getUserVisibleHint:"+getUserVisibleHint());
        if (getActivity() instanceof  MainActivity) {
            MainActivity mainActivity = (MainActivity) getActivity();
            if (needsRefresh) {
                Logger.log("CallsTabYourCallsFragment - onResume - needsRefresh");
                needsRefresh = false;
                loadData();
            }
        }
    ...
    public void update(SortedSet<Cdr> newCdrs) {
        Logger.log("CallsTabYourCallsFragment - update - count newCdrs:"+newCdrs.size());
    ...
    public void loadData() {
        ...
        cdrs.clear();
        sections.clear();
        //ImmutableMap<String, String> callHistoryParams = ImmutableMap.of("deptName", "%Customer%", "maxRecordsBack", String.valueOf(PicupApplication.pageSize), "applicationId", PicupApplication.apiId);
        ...
        call.enqueue(new Callback<CallHistory>() {
            ...
            public void onResponse(Call<CallHistory> call, Response<CallHistory> response) {
                Logger.log("CallTabYourCallsFragment - loadData - request callHistory - onResponse");
                swipeRefreshLayout.setRefreshing(false);
                if (response.isSuccessful()) {
                    ...
                    if (callHistory != null) {
                        ...
                        //TODO...need to segment 'Your' vs Company
                        for (Cdr cdr : cdrs) {
                            Logger.log("CallsTabYourCallsFragment - loadData - cdr userName:"+cdr.getUserName()+" user first/last name:"+PicupApplication.authenticateInfo.getFirstName()+" "+PicupApplication.authenticateInfo.getLastName());
                            if (TextUtils.equals(cdr.getUserName(), PicupApplication.authenticateInfo.getFirstName()+" "+PicupApplication.authenticateInfo.getLastName())) {
                        ...
                        if (TextUtils.equals(picupNumber, "All Numbers")) {
                            ...
                            for (Cdr cdr : cdrs) {
                                Logger.log("CallsTabYourCallsFragment - loadData - cdr - ani:"+cdr.getAni()+" dnis:"+cdr.getDnis()+" callstate:"+cdr.getCallState());
                                //UNITE 1490
                        ...
                        callListView.setAdapter(adapter);
                        adapter.notifyDataSetChanged();
                        //callListView.setOnScrollListener(CallsTabYourCallsFragment.this);
                    }
                } else {
                    if (response.errorBody() != null)
                        try {
                            Logger.log("CallsTabYourCallsFragment - loadData - failed - response:"+response.errorBody().string());
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
    ...
    public void filter(String picupNumber) {
        ...
        if (!filteredCdrs.isEmpty()) {
            ...
            for (Cdr filteredCdr : filteredCdrs) {
                Map.Entry<Calendar, List<Cdr>> entry = sections.floorEntry(filteredCdr.getCallCalendar());
                entry.getValue().add(filteredCdr);
            }
            Iterator<Map.Entry<Calendar, List<Cdr>>> entries = sections.entrySet().iterator();
            if (adapter == null) {
    ...
    public void fetchMore() {
        ...
        call.enqueue(new Callback<CallHistory>() {
            @Override
            public void onResponse(Call<CallHistory> call, Response<CallHistory> response) {
                Logger.log("CallTabYourCallsFragment - fetchMore - request callHistory - onResponse");
                if (response.isSuccessful()) {
                    ...
                    for (Cdr latestCdr : latestCdrs) {
                        Map.Entry<Calendar, List<Cdr>> entry = sections.ceilingEntry(latestCdr.getCallCalendar());
                    ...
                    if (response.errorBody() != null)
                        try {
                            Logger.log("CallsTabYourCallsFragment - fetchMore - failed - response:"+response.errorBody().string());
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                }
    ...
    public interface OnCallsTabYourCallsFragmentListener {
        void reAuthenticate();
    ...
    public class CallArrayAdapter extends ArrayAdapter<Cdr> {
        ...
        public View getView(final int position, final View convertView, ViewGroup parent) {
            ...
            Logger.log("CallsTabYourCallsFragment - getView - numToCheck:"+numToCheck);
            ...
            Logger.log("CallsTabYourCallsFragment - getView - thumbnailUriString:"+thumbnailUriString+" fullName:"+fullName);
            if (!TextUtils.isEmpty(thumbnailUriString)) {
                ...
                holder.thumbnailImageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Logger.log("CallsTabYourCallsFragment - thumbnail - onClick");
                ...
                holder.infoIconView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        Logger.log("CallsTabYourCallsFragment - infoIcon - onClick");
                ...
                Logger.log("CallsTabYourCallsFragment - getView - missing contact");
            ...
            holder.callerInfoLayout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Logger.log("CallsTabYourCallsFragment - onClick - call - tag:"+(String)v.getTag());
                    //listener.showContactProfile(this, cursorRef.getInt(PROFILE_ID_INDEX));
                    listener.call((String)v.getTag());
                }
            });
