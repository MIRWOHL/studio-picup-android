...
public abstract class SectionCursorAdapterOld extends CursorAdapter {
    private static final String TAG = "SectionCursorAdapterOld";
    ...
    public SectionCursorAdapterOld(Context context, Cursor c, int headerLayout, int groupColumn) {
        super(context, c, 0);
